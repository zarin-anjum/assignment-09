...
const Wishlist = () => {
  ...
  return (
    <div className="px-6 md:px-12 lg:px-16 py-10 bg-[#E0F7FA]">
      <h1 className="text-3xl font-bold text-[#1E3A8A] mb-6">My Wishlist</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {wishlist.map((toy) => (
          ...
          >
            ...
            <h2 className="text-xl font-bold text-[#1E3A8A]">{toy.toyName}</h2>

            <p className="text-gray-600 mt-1">
              Price:{" "}
              <span className="font-semibold text-[#006064]">${toy.price}</span>
            </p>
